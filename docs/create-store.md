...
an environment variable for you to utilize - `REACT_APP_STORE_OWNER_ADDRESS` - which you should set to be your
wallet public address. To do this, you can create a `.env` file in `packages/web`, and set
`REACT_APP_STORE_OWNER_ADDRESS` to be your wallet public address in there.

```
REACT_APP_STORE_OWNER_ADDRESS=YOUR_PUBLIC_WALLET_ADDRESS
```
